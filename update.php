...
<div class="content update">
    ...
    <form action="update.php?id=<?=$contact['id']?>" method="post">
        ...
        <input type="text" name="name" placeholder="Chamyae mharzi" value="<?=$contact['name']?>" id="name" required>
        <label for="email">Email</label>
        <label for="phone">Phone</label>
        <input type="text" name="email" placeholder="example@example.com" value="<?=$contact['email']?>" id="email" required>
